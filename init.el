...
(custom-set-variables
 ...
 '(package-selected-packages
   '(swift-mode php-mode phps-mode csv-mode exec-path-from-shell dtrt-indent dockerfile-mode cmake-mode django-mode pytest yaml-mode use-package undo-tree smartparens smart-mode-line reveal-in-osx-finder nose matlab-mode markdown-mode magit iedit helm-projectile helm-gtags flycheck-pos-tip cuda-mode company auctex))
 '(preview-gs-options
